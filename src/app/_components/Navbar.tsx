        ...
        <nav className=" border-gray-200 dark:bg-gray-900 dark:border-gray-700">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a href="#" className="flex items-center">
                    <Image src="/NEWlogo.png" width={50} height={50} alt='' />
                    <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">AIHT -DEPARTMENT OF COMPUTER SCIENCE</span>
                </a>
                <button data-collapse-toggle="navbar-dropdown" type="button"
                onClick={()=>{flag==="hidden"?setFlag("block"):setFlag("hidden")}}
                ...
                <div className={`${flag} w-full md:block md:w-auto z-10`} id="navbar-dropdown">
